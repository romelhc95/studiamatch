...
| Fase vigente | Macrofase `F9` completada y `F10` en rebaseline metadata. F10.9 conserva `G4=STOP_REQUIRES_REBASELINE`. [M2 post-merge](../../operaciones/m2_f10_10_post_merge_evidence_2026_08_10.md) registra M1/M2 PASS. La [evidencia M3](../../operaciones/m3_f10_10_post_merge_evidence_2026_08_11.md) registra el collector promovido por PR #350 y sus checks post-merge PASS; los gates Free/Certification/Pro no estan consumidos. M4-M10 no estan autorizados. Hito 1 permanece `TECHNICALLY_DELIVERED_FORMAL_CLOSURE_PENDING`. |
...
4. `M3`: `M3_COLLECTOR_PROMOTED_REMOTE_GATES_PENDING`; PR #350 y la evidencia post-merge completan la promocion sin consumir gates. Free usa SQL full-population/read-only solo despues de `APPROVE_M3_FREE_READONLY`, seguido por replay Certification y Pro con gates separados.
