...
`REQ7_LOCAL_REMEDIATION_IN_PROGRESS`
...
PR #447 queda `FAILED_NOT_MERGED_FROZEN`: candidate `5fb39b870206742b20d904ee73589d9b61adff3b`, run `32796093059`, fallo pre-merge `Promotion Readiness`, `Promotion Boundary` cancelado y PR cerrado administrativamente sin merge. `R3-GOV-HOM-012-O2-REQ1` queda consumido; `R3-GOV-HOM-012-O3/O4/O5-REQ1` quedan `SUPERSEDED_NOT_USABLE`. REQ7 prepara grants y ramas `REQ2` sin reutilizar PR #447 ni su grant.
...
- Registrar `R3-GOV-HOM-012-O2-REQ1=CONSUMED_BY_FAILURE` por PR #447 y HOM-012 REQ1 O3-O5 como `SUPERSEDED_NOT_USABLE`.
- Preparar `R3-GOV-HOM-012-O2/O3/O4/O5-REQ2` y ramas `promote/gov-hom-012-o2/o3/o4/o5-req2`.
...
- Tests offline para bloquear #447/REQ1 y aceptar solo ramas/grants HOM-012 REQ2.
- Siguiente gate unico: `PREPARE_WP_GOV_CI_012_REQ7_R2_APPROVAL`.
...
## Validacion Local REQ7

- Pendiente: focales, suite governance, validadores, secret scan, QA/security/release y digest final.
- Alcance: congelar PR #447/REQ1, superseder O3-O5 REQ1 y preparar REQ2 para nuevo O2 posterior a R2.
