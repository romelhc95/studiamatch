...
| Candidate | `desarrollo@5b282461149b7319685cf090534e28051e5eb32c` (F9.8 local), `certificacion@920ac9c7514f2e5f2e0315bf4cccb95940f3de17` (PR #277), controles F9.10 en `certificacion@bc227629b8df1fcabca47ea7be3ea1d5b4c7667b` (PR #282) y PR #283 en `desarrollo@5cfd93f626b3362c5c148b1d680ae948ce0218ea` pendiente de replay selectivo |
...
ejecutarlos. PR #283 quedo fusionado en `desarrollo` con CI post-merge PASS, pero requiere correccion repository-only, re-freeze y replay selectivo antes de `USER_PERSONAL_UAT`. Produccion observada, conformidad, PR a main, canary Production y schedules siguen pendientes. El resultado final debera
...
| Development/Certification/Production | `CERTIFICATION_DEVIATION_DOCUMENTED_F9_10_CONTROLS_IN_PROGRESS` | PR #277 y PR #282 Approved/Merged; PR #283 mergeado en `desarrollo`; replay selectivo a `certificacion`, Production y main pendientes |
...
- F9.10 readiness: run `30824041542` PASS read-only/sanitizado; PR #283 CI post-merge PASS (`30856264196`, `30856264217`); proyeccion PR #283 a `certificacion@bc227629b8df1fcabca47ea7be3ea1d5b4c7667b` = 23 paths, digest `2459cedda5542c81eb5bafca460148ebb6b65551c865fdcbe174ccee02edfb36`, sujeto a re-freeze despues del PR correctivo. No DML y no sustituye `USER_PERSONAL_UAT`. El canary Production futuro queda definido con artifacts sin slug/SHA/run/digest privado.
...
- Readiness F9.10: controles de repositorio en ejecucion; requiere PR correctivo a `desarrollo`, replay selectivo a `certificacion`, validaciones, PRs SDLC y `USER_PERSONAL_UAT` antes de F10.
