...
4. F9.5 pasa a ser el preflight Free read-only dirigido. No agrega adapter ni framework y solo puede ejecutarse con autorizacion decimal exacta propia.
5. La secuencia restante es F9.6 backup/remediacion H-00 Free-only, F9.7 backup/schema/RLS Free, F9.8 aprobacion de backfill, F9.9 ejecucion/certificacion de backfill y F9.10 certificacion final Free.
...
- F9.5 no queda autorizada por el cierre F9.4.
