...
17. F10.10 queda `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_BOUND_PENDING_HUMAN_APPROVAL`: candidate PR #367 promovido y binding externo pendiente, sin ejecucion remota. Demas fases bloqueadas.
...
| `F10.10` | `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_BOUND_PENDING_HUMAN_APPROVAL` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): PR #367 candidate, binding externo pendiente y sin ejecucion. Q0, lectura y teardown no consumidos. |
