...
17. F10.10 queda `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_POST_MERGE_VERIFIED_GATE_PENDING`: PR #369 fue aprobado/fusionado en `desarrollo@6068f2ac9ef623e06dcc23d9828980641e396c39` / tree `6a7ebe58b0acdc79bafe8362239c797e7256e31f`, con Security Audit `31701896740=PASS` y contrato PostgreSQL 17 `31701896698=PASS`. El gate Free v2 sigue propuesto, no creado, no aprobado y no consumido; no autoriza remediacion, postflight ni reader.
...
| `F10.10` | `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_POST_MERGE_VERIFIED_GATE_PENDING` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): PR #369 y checks post-merge PASS. `APPROVE_F10_10_M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2` permanece propuesto, no creado, no aprobado y no consumido; remediacion/postflight/reader, Q0, M4+, Certification y Pro no autorizados. |
