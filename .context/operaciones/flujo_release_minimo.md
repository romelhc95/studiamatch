...
- F9.7 schema/RLS, F9.8 plan de backfill, F9.9 ejecucion de backfill y F9.10 certificacion Free son gates distintos; F9.7 conserva candidate local y una remediacion no ejecutable bloqueada por atribucion ACL.
