...
- F9.7 schema/RLS, F9.8 plan de backfill, F9.9 ejecucion de backfill y F9.10 certificacion Free son gates distintos; F9.7 tiene remediacion local v3 PR-ready para acceso/trigger y sigue bloqueada por snapshot remoto y gates operativos. PR-O debe crear el contrato sucesor F9.7 v3; el T02 historico F10 no se reactiva.
