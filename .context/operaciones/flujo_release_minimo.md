...
17. F10.10 queda `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2_PAYLOAD_CANDIDATE_PENDING_PROMOTION_CONSUMER_BINDING_REQUIRED`: PR #370 post-merge PASS; payload v2 null-bound candidate preparado. Debe promoverse y luego adaptar/promover el consumidor canónico target/transport antes de cualquier aprobación o consumo.
...
| `F10.10` | `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2_PAYLOAD_CANDIDATE_PENDING_PROMOTION_CONSUMER_BINDING_REQUIRED` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): payload v2 null-bound candidate pendiente de promoción. Consumer/binding canónico, gate, red Free y etapas posteriores no autorizados. |
