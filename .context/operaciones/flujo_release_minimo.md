...
- PR #440 completo O2 HOM-008 y consumio `R3-GOV-HOM-008-O2-REQ1`, pero el push post-merge fallo `POST_MERGE_MERGER_INVALID`; HOM-008 queda superseded y no autoriza O2/O3 hasta publicar GOV-CI9, aplicar owner-only mediante R3 JIT y ejecutar nuevo re-O2 HOM-009.
