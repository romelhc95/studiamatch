...
17. F10.10 mantiene la remediacion metadata en `M3_READER_PREFLIGHT_PAYLOAD_READY_GATE_PENDING`. PR #353 promovio el collector v2 solo `FREE_DB`; PR #354/#355 reconciliaron evidencia/rotacion y PR #356 promovio binding offline passwordless. CI post-merge PASS valido package/compensacion, aislamiento Pro, Q0 predecessor y teardown. El payload exacto esta listo; gate literal precede cualquier preflight. Certification, Pro, M4 y F10.9/G4 siguen bloqueados.
...
| `F10.10` | `M3_READER_PREFLIGHT_PAYLOAD_READY_GATE_PENDING` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): candidate/binding promovidos, rotacion atestada y [payload preflight](./m3_reader_f10_10_preflight_payload_2026_08_11.json) listo sin password/red. Gate preflight y gates posteriores no consumidos; NOLOGIN inicial, Q0/collect encadenados, aislamiento Pro y teardown quarantine-first. |
