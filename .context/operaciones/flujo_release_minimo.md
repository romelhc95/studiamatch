...
| `F10.10` | `M3_COLLECTOR_CANDIDATE_PENDING_PROTECTED_MERGE` | M1/M2 integrados segun [evidencia M2](./m2_f10_10_post_merge_evidence_2026_08_10.md); [scope M3](./m3_f10_10_scope_por_ambiente_target.md) fija collector candidate -> merge/evidencia -> Free -> Certification replay -> Pro. Ninguna capacidad remota se concede antes de la promocion ni sin el gate exacto del target. |
