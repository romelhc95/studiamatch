...
17. F10.10 mantiene la remediacion metadata detenida en `M3_READER_REBASELINE_CANDIDATE_PENDING_PROTECTED_MERGE`. El collector v2 es solo `FREE_DB`: package/compensacion excluidos de deteccion Pro-relevant, rol inicialmente NOLOGIN, activacion privada Q0, predecessor Q0 obligatorio para collect y teardown quarantine-first. PR protegido y CI/post-merge preceden cualquier gate. Certification, Pro, M4 y F10.9/G4 siguen bloqueados.
...
| `F10.10` | `M3_READER_REBASELINE_CANDIDATE_PENDING_PROTECTED_MERGE` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): NOLOGIN inicial, Q0/collect encadenados, provisioner cerrado, aislamiento DB Sync Pro y teardown quarantine-first. PR #350 queda antecedente; merge protegido y CI/post-merge pendientes. |
