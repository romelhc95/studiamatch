...
- F9.7 schema/RLS/corte local, F9.8 plan de backfill, F9.9 ejecucion de backfill y F9.10 certificacion Free son gates distintos; F9.7 tiene v3 byte-identico, PR-O v1/hold actual `SUPERSEDED_NON_PROMOTABLE` y PR-O sucesor con executor privado `GO_WP_LOCAL`; sigue bloqueada por certificacion local separada del sucesor, aprobacion Free independiente, snapshot remoto y gates operativos. El T02 historico F10 no se reactiva.
