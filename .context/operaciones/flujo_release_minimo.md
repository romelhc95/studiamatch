...
- F9.7 schema/RLS/corte local, F9.8 plan de backfill, F9.9 ejecucion de backfill y F9.10 certificacion Free son gates distintos; F9.7 tiene v3 byte-identico y security hold terminal local bloqueado, y sigue bloqueada por snapshot remoto y gates operativos. PR-O debe crear el contrato combinado v3 + hold; el T02 historico F10 no se reactiva.
