...
17. F10.10 mantiene la remediacion metadata en `M3_DDL_NULLABILITY_REMEDIATION_PENDING`. Preflight termino PASS; DDL v1 fue consumida una vez y revertida por drift de nullability, sin reader persistido. La remediacion v2 queda offline, sin binding ni capacidad ejecutable; Q0, lectura y teardown no consumidos. Certification, Pro, M4 y F10.9/G4 siguen bloqueados.
...
| `F10.10` | `M3_DDL_NULLABILITY_REMEDIATION_PENDING` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): preflight PASS; DDL v1 consumida/fallida con rollback y superseded. Remediacion v2 offline sin binding; Q0, lectura y teardown no consumidos. NOLOGIN inicial, aislamiento Pro y teardown quarantine-first permanecen obligatorios. |
