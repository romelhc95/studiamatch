...
| `F10.10` | `M3_COLLECTOR_PROMOTED_REMOTE_GATES_PENDING` | M1/M2 integrados segun [evidencia M2](./m2_f10_10_post_merge_evidence_2026_08_10.md); [evidencia M3](./m3_f10_10_post_merge_evidence_2026_08_11.md) registra PR #350 y checks post-merge PASS. [Scope M3](./m3_f10_10_scope_por_ambiente_target.md) fija Free -> Certification replay -> Pro. Ninguna capacidad remota se concede sin el gate exacto del target. |
