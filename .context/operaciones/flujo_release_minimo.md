...
17. F10.10 queda `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_PAYLOAD_PENDING_HUMAN_APPROVAL`: PR #366 y checks post-merge PASS enlazados; v2 superseded sin ejecucion y envelope v3 añade atestacion PostgreSQL 17. Demas fases bloqueadas.
...
| `F10.10` | `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_PAYLOAD_PENDING_HUMAN_APPROVAL` | [Scope v2 Free-only](./m3_f10_10_scope_por_ambiente_target.md): PR #366 autoridad, v2 superseded sin ejecucion y v3 pendiente. Q0, lectura y teardown no consumidos. |
