...
11. El [rebaseline M3 reader](./m3_reader_f10_10_rebaseline.md) debe fusionarse
    por PR protegido y pasar CI/post-merge antes de cualquier preflight/DDL/Q0 o
    lectura Free; Certification, Pro y M4 permanecen bloqueados.
...
| `F10.10` | `M3_READER_REBASELINE_CANDIDATE_PENDING_PROTECTED_MERGE` | [Scope M3 v2](./m3_f10_10_scope_por_ambiente_target.md): exclusivamente `FREE_DB`; rol NOLOGIN inicial, provisioner PostgreSQL 17 cerrado, Q0 predecessor obligatorio, digests binding/transport distintos, aislamiento Pro y teardown quarantine-first. PR #350 queda antecedente. Candidate, CI/post-merge, metadata cero y M4+ permanecen pendientes. |
