...
| `F10.10` | `M3_DDL_NULLABILITY_REMEDIATION_PENDING` | [Scope M3 v2](./m3_f10_10_scope_por_ambiente_target.md): preflight PASS; DDL v1 consumida/fallida con rollback y superseded. Remediacion v2 offline sin binding; Q0/lectura/teardown, metadata cero y M4+ permanecen pendientes. |
