...
| Estado | `F10_10_M3_COLLECTOR_CANDIDATE_PENDING_PROTECTED_MERGE` |
...
| `F10.10` | `M3_COLLECTOR_CANDIDATE_PENDING_PROTECTED_MERGE` | [ADR-0010](../decisiones/ADR-0010_rebaseline_f10_10_metadata_remediation.md), [PLAN-F10.10-001](./plan_remediacion_metadata_f10_10.md), [evidencia M2](./m2_f10_10_post_merge_evidence_2026_08_10.md) y [scope M3](./m3_f10_10_scope_por_ambiente_target.md) registran el collector candidate read-only pendiente de merge/evidencia. Metadata cero y toda ejecucion remota M3+ permanecen pendientes. |
