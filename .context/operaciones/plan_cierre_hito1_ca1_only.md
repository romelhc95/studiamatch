...
| `F10.10` | `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V2_PAYLOAD_PENDING_HUMAN_APPROVAL` | [Scope M3 v2](./m3_f10_10_scope_por_ambiente_target.md): PR #365 promovido y payload v2 enlazado sin ejecucion. Q0/lectura/teardown, metadata cero y M4+ permanecen pendientes. |
