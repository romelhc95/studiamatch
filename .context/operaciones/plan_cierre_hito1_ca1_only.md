...
| `F10.10` | `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_POST_MERGE_VERIFIED_GATE_PENDING` | PR #369 y CI post-merge PASS; `APPROVE_F10_10_M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2` permanece propuesto, no creado, no aprobado y no consumido. Remediacion/postflight/reader, Q0, M4+, Certification y Pro siguen bloqueados. |
