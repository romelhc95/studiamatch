...
| `F10.10` | `M3_PUBLIC_DB_ACL_DIAGNOSTIC_STOP_BINDING_REQUIRED` | [Scope M3 v2](./m3_f10_10_scope_por_ambiente_target.md): gate diagnostico v1 consumido en STOP pre-red; candidate sucesor en preparacion. Q0/lectura/teardown, metadata cero y M4+ permanecen pendientes. |
