...
| `F10.10` | `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2_PAYLOAD_POST_MERGE_VERIFIED_CONSUMER_BINDING_REQUIRED` | PR #371 promovio el payload v2 null-bound; PR #372 remedio el harness y los checks post-merge sobre `desarrollo@89cbeda226c6e04c6c1b6e091e6b94fc36273645` quedaron PASS. Consumer/binding canónico, gate y etapas posteriores siguen no autorizados. |
