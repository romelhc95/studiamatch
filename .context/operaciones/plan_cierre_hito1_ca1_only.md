...
| `F10.10` | `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2_PAYLOAD_CANDIDATE_PENDING_PROMOTION_CONSUMER_BINDING_REQUIRED` | PR #370 post-merge PASS; payload v2 null-bound candidate pendiente de promoción. Consumer/binding canónico, gate y etapas posteriores siguen no autorizados. |
