...
- `estado_del_proyecto.md` debe declarar `F10.11` en preparacion `GOV-CI12_REQ7`, `F12.1` bloqueada por homologacion y rebaseline, `active_work_package = WP-H2-001`, `WP-H2-001=ACTIVE_R1`, PR #447 congelado por fallo HOM-012 REQ1 y `PREPARE_WP_GOV_CI_012_REQ7_R2_APPROVAL`.
- El Plan Maestro debe mantener O0-O5 historicos completados, Etapa 1 Obsidian como `DESARROLLO_MERGED_PENDING_HOMOLOGATION`, `WP-H2-001` activo hasta R1, PR #424, PR #425, PR #426, PR #427, PR #429, PR #430, PR #432, PR #434, PR #436, PR #438, PR #439, PR #441, PR #442, PR #444, PR #446 y PR #448 publicados en `desarrollo`, PR #428 como `O2_CONSUMED_BY_FAILURE`, PR #431 como `R3-GOV-HOM-003-O2-REQ1_CONSUMED_BY_FAILURE`, PR #433 como O2 mergeado con run post-merge `32615044699` fallido, PR #435 como `R3-GOV-HOM-005-O2-REQ1_CONSUMED_BY_FAILURE`, PR #437 como O2 mergeado con run post-merge `32650341464` fallido, PR #438 como run post-merge `32655520324` fallido, PR #440 como O2 mergeado con run post-merge `32662084712` fallido, PR #441 como run post-merge `32666126533` fallido con `POST_MERGE_ATTESTATION_DUPLICATE`, PR #443, PR #445 y PR #447 como `FAILED_NOT_MERGED_FROZEN`, y el proximo gate unico `PREPARE_WP_GOV_CI_012_REQ7_R2_APPROVAL`.
...
- El indice debe enlazar `WP-GOV-ARCH-001` y `TASK-GOV-ARCH-001` como artifacts consumidos por PR #425, `WP-GOV-HOM-001`/`TASK-GOV-HOM-001` como artifacts consumidos por PR #426, `WP-GOV-CI-001`/`TASK-GOV-CI-001` como artifact consumido por PR #427, `WP-GOV-CI-002`/`TASK-GOV-CI-002` como artifact consumido por PR #429, `WP-GOV-CI-003`/`TASK-GOV-CI-003` como artifact consumido por PR #430, `WP-GOV-CI-004`/`TASK-GOV-CI-004` como artifact consumido por PR #432, `WP-GOV-CI-005`/`TASK-GOV-CI-005` como artifact consumido por PR #434, `WP-GOV-CI-006`/`TASK-GOV-CI-006` como artifact consumido por PR #436, `WP-GOV-CI-007`/`TASK-GOV-CI-007` como artifact publicado por PR #438 con fallo post-merge, `WP-GOV-CI-008`/`TASK-GOV-CI-008` como artifact publicado por PR #439 con O2 #440 fallido, `WP-GOV-CI-009`/`TASK-GOV-CI-009` como artifact publicado por PR #441 con fallo post-merge, `WP-GOV-CI-010`/`TASK-GOV-CI-010` como artifact consumido por PR #442, `WP-GOV-CI-011`/`TASK-GOV-CI-011` como artifact publicado por PR #444 con O2 #445 fallido, y `WP-GOV-CI-012`/`TASK-GOV-CI-012` como candidate causal evidence; el siguiente gate unico es `PREPARE_WP_GOV_CI_012_REQ7_R2_APPROVAL`.
...
GOV-CI12 congela PR #443, PR #445 y PR #447 como `FAILED_NOT_MERGED_FROZEN`, marca `R3-GOV-HOM-011-O2-REQ1` y `R3-GOV-HOM-012-O2-REQ1` consumidos, supersede HOM-011 O3-O5 y HOM-012 REQ1 O3-O5. HOM-012 REQ2 requiere `promotion-jit-envelope-v3`, una sola aprobacion Environment `Promotion` pre-merge, evidencia `promotion-approval-evidence.json`, post-merge sin secret ni Environment, collector REST Python testeable, `bypass_actors=UNOBSERVABLE` tolerado solo como no observable, O3 asincronico con `o3-closure-evidence.json`, O4 consumidor real y O5 trees/ancestry.
