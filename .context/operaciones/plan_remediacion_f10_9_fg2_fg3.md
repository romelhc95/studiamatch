...
| `G5` | `REPOSITORY_ONLY_TRUST_BROKER_PR_B_LOCAL_CANDIDATE` | PR #384 corresponde solo a PR A y queda `MERGED_POST_MERGE_VERIFIED`: candidate `9414480b6cb6496fc978b7379a5b24a1ae9e1f60`, merge `7a4c6420214dd1ffcc367b1f35cb5f553d07c99c` / tree `4c647e87a4effbc577d1653fd023375c2c87fa3e`; Security `31899873186=PASS`, focused `95048814844=PASS`, F9.7 run `31899873143=PASS` / job `95048918881=PASS`, attempt 1. PR B no esta fusionado ni post-merge verificado; su candidate local define [ADR-0013](../decisiones/ADR-0013_trust_broker_durable_object_ledger.md), broker OIDC/GitHub App y Durable Object CAS offline. Gate real, trust operacional y connected mode permanecen bloqueados; cero deployment, configuracion remota, Supabase/SQL, writers o schedules. |
