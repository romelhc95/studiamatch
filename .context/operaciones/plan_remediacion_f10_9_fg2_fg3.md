...
| `G5` | `REPOSITORY_ONLY_WORKFLOW_CONNECTED_PR_C_LOCAL_CANDIDATE` | PR #384 corresponde solo a PR A y queda `MERGED_POST_MERGE_VERIFIED`: candidate `9414480b6cb6496fc978b7379a5b24a1ae9e1f60`, merge `7a4c6420214dd1ffcc367b1f35cb5f553d07c99c` / tree `4c647e87a4effbc577d1653fd023375c2c87fa3e`; Security `31899873186=PASS`, focused `95048814844=PASS`, F9.7 run `31899873143=PASS` / job `95048918881=PASS`, attempt 1. PR #385, PR B, queda `MERGED_POST_MERGE_VERIFIED`: candidate `09851459f2ffa751e2e8139d4e9a3304427f1ee4`, merge `191539de71cbff95552c476463305e8d6f3e4b73` / tree `7fe13bb907053f4dea51ac593b5df0de78cb40d6`; Security `31903582727=PASS`, trust broker `95057934429=PASS`, F9.7 run `31903582617=PASS` / job `95058032300=PASS`, attempt 1. PR C local define [ADR-0014](../decisiones/ADR-0014_g5_manual_workflow_connected_adapter_disabled.md), workflow manual placeholder deshabilitado y connected adapter fail-closed antes de transporte. Gate real, trust operacional y connected mode permanecen bloqueados; cero deployment, workflow ejecutado, configuracion remota, Supabase/SQL, writers o schedules. |
