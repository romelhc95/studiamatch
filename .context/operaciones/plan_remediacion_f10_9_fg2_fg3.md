...
| `G5` | `REPOSITORY_ONLY_TRUST_PLANE_PR_A_STOP` | PR #383 queda `MERGED_POST_MERGE_VERIFIED` mediante candidate `b921ee90d3ea4966602c3ca4b12a740d3721baa7` y merge protegido `9045c90ac78634f17a66cb3e30e723a2431cb6b4` / tree `3d8455a29b63a38906a67343ee4ba6dd15b366d7`; Security Audit `31896356316=PASS`, F9.7 `31896356280=PASS` y focused v2.3 `95040164691=PASS`. V2.3 queda congelado. PR A repository-only del trust-plane define [ADR-0012](../decisiones/ADR-0012_trust_plane_g5_repository_only.md), elimina autoridad caller-supplied y modela OIDC, bindings, approval numerico, deployment, gate receipt y ledger cerrado offline. Termina `STOP_G5_TRUST_VERIFICATION_NOT_IMPLEMENTED`; gate `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED`, connected mode `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`; cero Production, transporte, providers live, SQL, writers o schedules. |
