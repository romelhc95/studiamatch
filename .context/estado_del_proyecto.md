...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.10 queda `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_BOUND_PENDING_HUMAN_APPROVAL`: PR #367 promovio el candidate v3; binding externo inmutable pendiente de verificacion post-merge y aprobacion. Sin ejecucion remota. |
...
| `F10.10` | `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_BOUND_PENDING_HUMAN_APPROVAL` | Candidate PR #367 `daf3e5babb2f6185304973e4f7607d95d85ab130` / tree `da047276b78cea8c1a2b8bf7048a6f40c0146f2b`; checks `31628757140` y `31628757098` PASS. Gate bound pendiente, no ejecutado. |
...
- Subfase tecnica activa: F10.10 `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_BOUND_PENDING_HUMAN_APPROVAL`. Gates v1/v2/v3 no ligado no reutilizables; identidad bound pendiente.
...
- Siguiente accion: verificar y aprobar el binding externo tras su merge protegido; esta promocion no ejecuta la lectura.
