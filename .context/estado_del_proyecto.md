...
Snapshot: `SNAPSHOT-2026-08-11-F10.10-M3-READER-POST-MERGE`.
...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.8 queda `COMPLETED_PRODUCTION_CANARY_VERIFIED`; F10.9 conserva `STOP_REQUIRES_REBASELINE`. PR #350 permanece antecedente v1. La [evidencia M3 reader v2](operaciones/m3_reader_f10_10_post_merge_evidence_2026_08_11.md) registra PR #353 y CI post-merge PASS en `desarrollo@2cf614a4a44ffabc5e06ba08dc20707807db274f`; F10.10 queda `M3_READER_POST_MERGE_VERIFIED_GATES_PENDING`. Ningun gate fue consumido. Hito 1 sigue `TECHNICALLY_DELIVERED_FORMAL_CLOSURE_PENDING`. |
...
| `F10.10` | `M3_READER_POST_MERGE_VERIFIED_GATES_PENDING` | [Scope M3 v2](operaciones/m3_f10_10_scope_por_ambiente_target.md), [rebaseline](operaciones/m3_reader_f10_10_rebaseline.md) y [evidencia post-merge](operaciones/m3_reader_f10_10_post_merge_evidence_2026_08_11.md) fijan `FREE_DB` como unico target. PR #353 fue aprobado/fusionado; Security Audit `31497100919=PASS`, F9.7 `31497100928=PASS`, M3 zero-write/PostgreSQL 17 networkless PASS. Cero acceso/DDL remoto y cero gates consumidos; preflight bloqueado por atestacion sanitizada de rotacion y gate exacto pendientes. |
...
- Subfase tecnica activa: F10.10 `M3_READER_POST_MERGE_VERIFIED_GATES_PENDING`. F10.9 conserva `STOP_REQUIRES_REBASELINE`; G5-G13, Certification, Pro, M4-M10, schedules, observacion y F11.1 siguen suspendidos. El merge y CI post-merge no conceden llamadas remotas, DDL ni manejo de passwords.
...
- Siguiente accion: obtener atestacion sanitizada de rotacion/revocacion de la credencial canary local prohibida y, solo despues, preparar para revision humana un payload exacto de `APPROVE_F10_10_M3_READER_PREFLIGHT_FREE` ligado al merge/tree/digests promovidos. Los gates de preflight, DDL Free, Q0 Free, lectura y teardown permanecen no consumidos y ninguno concede el siguiente.
