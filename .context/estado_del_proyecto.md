...
| `F9` | Certificacion Hito 1 en Free | `IN_PROGRESS` | Corte local F9.7 fusionado en `desarrollo`; v3 sigue byte-identico y el security hold queda candidate bloqueado; Free sigue sin certificar. |
...
| `F9.7` | `IN_PROGRESS` | `security_cutoff_local_candidate` local cerrado y fusionado por PR #258; merge `e95eeaccc864477db587bbb13c827d0c17340d8d` conserva tree `2cb182ab9ece141bd8e84d7bbf9c91d771f603de`; `CORR-WP-F9.7-04-02` y `WP-F9.7-04..06` quedan cerrados localmente tras CI, seis auditorias `GO_FOR_LOCAL_PR`, aprobacion humana, merge humano y replay post-merge PASS; F9.7 permanece `IN_PROGRESS` hasta `GO_F9.7_COMPLETE` en Free; Free/Pro `UNCHANGED_NOT_ATTESTED`, security hold remoto bloqueado, Supabase previews skipped y sin Cloudflare manual |
