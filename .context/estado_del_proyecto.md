...
| `F10.9` | `REBASELINED_FG2_FG3_OPERATIONAL_REMEDIATION` | PR #384, que corresponde exclusivamente a PR A, queda `MERGED_POST_MERGE_VERIFIED`: candidate `9414480b6cb6496fc978b7379a5b24a1ae9e1f60`, merge protegido `7a4c6420214dd1ffcc367b1f35cb5f553d07c99c` / tree `4c647e87a4effbc577d1653fd023375c2c87fa3e`; Security `31899873186=PASS`, focused trust-plane `95048814844=PASS`, F9.7 run `31899873143=PASS` / job `95048918881=PASS`, `run_attempt=1`. PR #385, PR B, queda `MERGED_POST_MERGE_VERIFIED`: candidate `09851459f2ffa751e2e8139d4e9a3304427f1ee4`, merge protegido `191539de71cbff95552c476463305e8d6f3e4b73` / tree `7fe13bb907053f4dea51ac593b5df0de78cb40d6`; Security `31903582727=PASS`, trust broker `95057934429=PASS`, F9.7 run `31903582617=PASS` / job `95058032300=PASS`, `run_attempt=1`. PR C permanece `REPOSITORY_ONLY_WORKFLOW_CONNECTED_PR_C_LOCAL_CANDIDATE`: [ADR-0014](decisiones/ADR-0014_g5_manual_workflow_connected_adapter_disabled.md) agrega workflow manual placeholder deshabilitado y adapter conectado que termina `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED` antes de transporte. No hay deployment, Cloudflare remoto, GitHub App configurada, workflow ejecutado, Production, Supabase, SQL, writers, schedules ni red live. Gate `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED`; trust `STOP_G5_TRUST_VERIFICATION_NOT_IMPLEMENTED`; connected `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`. `G4=PASS_CA1_FG2_FG3_ONLY_METADATA_TRANSFERRED_TO_H2`; pares `0`, observacion `NOT_STARTED`. |
...
- Siguiente accion: promover mediante PR protegido el PR C repository-only del workflow manual deshabilitado y connected adapter G5 deshabilitado. Aun con broker/ledger probados offline, trust operacional permanece `STOP_G5_TRUST_VERIFICATION_NOT_IMPLEMENTED`; gate `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED`; connected mode `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`. Deployment, configuracion Cloudflare/GitHub App, Production, API/JWKS live, workflow ejecutado, protection rule, SQL, writers y schedules permanecen fuera.
