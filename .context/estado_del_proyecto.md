...
| `F10.9` | `REBASELINED_FG2_FG3_OPERATIONAL_REMEDIATION` | PR #383 queda `MERGED_POST_MERGE_VERIFIED` mediante candidate `b921ee90d3ea4966602c3ca4b12a740d3721baa7` y merge protegido `9045c90ac78634f17a66cb3e30e723a2431cb6b4` / tree `3d8455a29b63a38906a67343ee4ba6dd15b366d7`; Security Audit `31896356316=PASS`, F9.7 `31896356280=PASS` y focused v2.3 `95040164691=PASS`. V2.3 queda congelado en esa base. PR #382 permanece como antecedente v2.2 `HISTORICAL_ANTECEDENT_NOT_FIT_FOR_CONNECTED_MODE`. El [contrato offline GET-only](operaciones/g5_get_only_adapter_contract_2026_08_14.md) ahora define PR A repository-only del trust-plane G5: elimina autoridad caller-supplied, modela OIDC/bindings/approval/deployment/gate receipt/ledger cerrado y prueba replay/state machine offline. Termina `STOP_G5_TRUST_VERIFICATION_NOT_IMPLEMENTED`; gate `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED`; connected mode `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`. No hay transporte, Production, SQL, writers, schedules, GitHub API live, OIDC live ni consumo de gate. `G4=PASS_CA1_FG2_FG3_ONLY_METADATA_TRANSFERRED_TO_H2`; pares `0`, observacion `NOT_STARTED`. |
...
- Siguiente accion: abrir PR protegido para el PR A repository-only del trust-plane G5, bajo esta autorizacion F10.9. Aun con bindings OIDC/approval/deployment/gate receipt modelados y probados offline, termina `STOP_G5_TRUST_VERIFICATION_NOT_IMPLEMENTED`; el gate G5 permanece `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED` y connected mode permanece `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`. No implementar ni ejecutar connected mode, transporte, Production, GitHub API live, OIDC live, consumo real de gate, SQL, writers, schedules u observacion.
