...
| `F10.9` | `REBASELINED_FG2_FG3_OPERATIONAL_REMEDIATION` | PR #379 queda `MERGED_POST_MERGE_VERIFIED_REMEDIATION_REQUIRED` en `desarrollo@c28e5b86e6be29bbb2444bedd9b9407d1e7b0974` / tree `22de9d315ff26b0a8b0e8ae991a338473fbdbe11`; Security Audit `31839739068=PASS` y F9.7 `31839739054=PASS`. El [contrato offline GET-only](operaciones/g5_get_only_adapter_contract_2026_08_14.md) v1 queda antecedente historico no apto para connected mode; el sucesor repository-only usa contrato/schema/algoritmo v2 y termina `STOP_G5_TRUST_VERIFICATION_NOT_IMPLEMENTED`. Gate `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED`; connected mode `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`. `G4=PASS_CA1_FG2_FG3_ONLY_METADATA_TRANSFERRED_TO_H2`; pares `0`, observacion `NOT_STARTED`. |
