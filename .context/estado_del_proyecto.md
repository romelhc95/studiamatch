...
| `F10.9` | `REBASELINED_FG2_FG3_OPERATIONAL_REMEDIATION` | PR #375 queda `COMPLETED_POST_MERGE_VERIFIED` en `desarrollo@2c9d2438c5fc309d3692d1a1de1233e0fcc95afc` / tree `161a8df69bf5e527c4ba863891504551ec5f7aa7`; [G5 repository-only](operaciones/g5_production_readonly_candidate_2026_08_14.md) queda `G5_REPOSITORY_ONLY_CANDIDATE_PENDING_PROMOTION`. `G4=PASS_CA1_FG2_FG3_ONLY_METADATA_TRANSFERRED_TO_H2`; G5-G13 se reabren solo para blockers CA1 FG2/FG3, promociones protegidas, `GO_SCHEDULES` y tres pares naturales durante al menos 72 horas. Metadata no es gate de Hito 1. Pares aceptados `0`; observacion `NOT_STARTED`. |
...
- Siguiente accion: aprobar y fusionar el [candidate G5 repository-only](operaciones/g5_production_readonly_candidate_2026_08_14.md) por PR protegido a `desarrollo` y verificar CI/post-merge. `APPROVE_F10_9_G5_PRODUCTION_READONLY_DIAGNOSTIC_V1=NOT_CREATED_NOT_APPROVED_NOT_CONSUMED`; no ejecutar aun Production, remediacion, schedules ni observacion.
