...
- Siguiente accion: preparar para revision humana un payload exacto de `APPROVE_F10_10_M3_READER_DDL_FREE`. El gate preflight queda consumido; DDL Free, Q0 Free, lectura y teardown permanecen no consumidos y ninguno concede el siguiente.
