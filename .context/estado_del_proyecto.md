...
Snapshot: `SNAPSHOT-2026-08-12-F10.10-M3-PUBLIC-ACL-REMEDIATION-PREFLIGHT`.
...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.10 queda `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_CANDIDATE_PENDING_PROMOTION`: el diagnostico bound fue consumido una vez y produjo `STOP_PUBLIC_DB_ACL_REMEDIATION_REQUIRED`; TARGET y OTHER_CONNECTABLE son no conformes, NON_CONNECTABLE es conforme e inmutable. |
...
| `F10.10` | `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_CANDIDATE_PENDING_PROMOTION` | Autoridad merge `7034d93059da92b34fb77b06b870ad254f192623` / tree `a86b31d562d3ae094afe1b46da297827eee07020`; candidate diagnostico `daf3e5babb2f6185304973e4f7607d95d85ab130` / tree `da047276b78cea8c1a2b8bf7048a6f40c0146f2b`, checks `31628757140` y `31628757098` PASS. Gate bound `CONSUMED_ONCE`; una llamada `execute_sql`, sin retry, termino `STOP_PUBLIC_DB_ACL_REMEDIATION_REQUIRED`. |
...
- Subfase tecnica activa: F10.10 `M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_CANDIDATE_PENDING_PROMOTION`. El diagnostico bound queda consumido y no reutilizable; la siguiente capacidad es solo un candidate privado local pendiente de promocion.
...
- Siguiente accion: promover y verificar el candidate privado de preflight Free v2. Los gates futuros `APPROVE_F10_10_M3_PUBLIC_DB_ACL_PRIVATE_PREFLIGHT_FREE_V2`, `APPROVE_F10_10_M3_PUBLIC_DB_ACL_REMEDIATION_FREE_V1`, `APPROVE_F10_10_M3_PUBLIC_DB_ACL_POSTFLIGHT_FREE_V1` y, despues, reader v3 quedan solo propuestos: no creados, no aprobados y no consumidos.
