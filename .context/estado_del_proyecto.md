...
| `F10.10` | `M3_SCOPE_APPROVED_TARGET_AUTHORIZATIONS_PENDING` | [ADR-0010](decisiones/ADR-0010_rebaseline_f10_10_metadata_remediation.md), [PLAN-F10.10-001](operaciones/plan_remediacion_metadata_f10_10.md), [evidencia M2](operaciones/m2_f10_10_post_merge_evidence_2026_08_10.md) y [scope M3](operaciones/m3_f10_10_scope_por_ambiente_target.md) preservan la frontera fill-only/sin DDL. Ninguna lectura remota esta autorizada hasta consumir el gate exacto del target. |
...
- Subfase tecnica activa: F10.10 `M3_SCOPE_APPROVED_TARGET_AUTHORIZATIONS_PENDING`. F10.9 conserva `STOP_REQUIRES_REBASELINE`; G5-G13, schedules y observacion siguen suspendidos. El scope no concede llamadas remotas: Free, replay Certification y Pro conservan gates separados.
...
- Siguiente accion: implementar y promover por alcance separado el colector versionado `scripts/maintenance/f10_10_m3_readonly_collector.py` y sus zero-write tests. Solo despues puede aprobarse `APPROVE_M3_FREE_READONLY` con el payload completo. MCP solo puede ser sanity-check no autoritativo; Certification y Pro permanecen bloqueados.
