...
Snapshot: `SNAPSHOT-2026-08-10-F10.10-M0-POST-MERGE`.
...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.8 queda `COMPLETED_PRODUCTION_CANARY_VERIFIED`; F10.9 conserva `STOP_REQUIRES_REBASELINE`. [M0 F10.10 post-merge](operaciones/m0_f10_10_post_merge_evidence_2026_08_10.md) registra PR #343 fusionado en `desarrollo@f59c35272ccec930434b3ceeb1aee8eac732d4b9`, con Security Audit `31419218575=PASS` y F9.7 `31419218779=PASS`. M0 queda PASS y M1 autorizado exclusivamente local/offline. Hito 1 sigue `TECHNICALLY_DELIVERED_FORMAL_CLOSURE_PENDING`. |
...
| `F10.10` | `M0_PASS_M1_LOCAL_AUTHORIZED` | [ADR-0010](decisiones/ADR-0010_rebaseline_f10_10_metadata_remediation.md), [PLAN-F10.10-001](operaciones/plan_remediacion_metadata_f10_10.md) y la [evidencia M0](operaciones/m0_f10_10_post_merge_evidence_2026_08_10.md) preservan la frontera fill-only y sin DDL. M1 solo puede implementar tooling/fixtures/tests offline. M2-M10 requieren autorizaciones separadas y F10.9 no se reactiva automaticamente. |
...
- Subfase tecnica activa: F10.10 `M0_PASS_M1_LOCAL_AUTHORIZED`. F10.9 conserva `STOP_REQUIRES_REBASELINE`; G5-G13, schedules y observacion siguen suspendidos. M1 es exclusivamente offline y no autoriza Supabase, providers, environments, writers ni workflows operativos.
...
- Siguiente accion: aprobar y fusionar esta reconciliacion M0; tras checks post-merge puede ejecutarse la autorizacion M1 ya consumida para tooling, fixtures y pruebas offline. Ningun acceso remoto queda concedido.
