...
Snapshot: `SNAPSHOT-2026-08-11-F10.10-M3-READER-ROTATION-ATTESTED`.
...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.8 queda `COMPLETED_PRODUCTION_CANARY_VERIFIED`; F10.9 conserva `STOP_REQUIRES_REBASELINE`. PR #353 promovio M3 reader v2 y PR #354 reconcilio su evidencia/boundary en `desarrollo@1749d85b52ee2634e4089d578c09b18e7731f655`; Security Audit `31502723129=PASS` y F9.7/M3 `31502723190=PASS`. La [atestacion sanitizada](operaciones/m3_reader_f10_10_rotation_attestation_2026_08_11.md) cierra la rotacion requerida. F10.10 queda `M3_READER_ROTATION_ATTESTED_PREFLIGHT_GATE_PENDING`; ningun gate fue consumido. Hito 1 sigue `TECHNICALLY_DELIVERED_FORMAL_CLOSURE_PENDING`. |
...
| `F10.10` | `M3_READER_ROTATION_ATTESTED_PREFLIGHT_GATE_PENDING` | [Scope M3 v2](operaciones/m3_f10_10_scope_por_ambiente_target.md), [evidencia post-merge](operaciones/m3_reader_f10_10_post_merge_evidence_2026_08_11.md) y [atestacion de rotacion](operaciones/m3_reader_f10_10_rotation_attestation_2026_08_11.md) fijan `FREE_DB` como unico target. PR #353 promovio el candidate y PR #354 reconcilio evidencia/boundary; CI post-merge PASS. La contrasena SQL canary anterior queda rotada y revocada. Cero acceso/DDL remoto y cero gates consumidos; payload y aprobacion exacta de preflight siguen pendientes. |
...
- Subfase tecnica activa: F10.10 `M3_READER_ROTATION_ATTESTED_PREFLIGHT_GATE_PENDING`. F10.9 conserva `STOP_REQUIRES_REBASELINE`; G5-G13, Certification, Pro, M4-M10, schedules, observacion y F11.1 siguen suspendidos. La atestacion de rotacion no concede llamadas remotas, DDL ni manejo de passwords.
...
- Siguiente accion: preparar para revision humana un payload exacto de `APPROVE_F10_10_M3_READER_PREFLIGHT_FREE` ligado al merge/tree/digests promovidos y al binding privado todavia no resuelto. Los gates de preflight, DDL Free, Q0 Free, lectura y teardown permanecen no consumidos y ninguno concede el siguiente.
