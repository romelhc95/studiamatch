...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.10 queda `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_PAYLOAD_PENDING_HUMAN_APPROVAL`: PR #366 y checks post-merge PASS son la autoridad; envelope v3 añade atestacion PostgreSQL 17 y queda sin ejecutar. Q0, lectura y teardown no consumidos. |
...
| `F10.10` | `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_PAYLOAD_PENDING_HUMAN_APPROVAL` | PR #366 fusionado en `8e6d569dcc2d91479e48172bf18f3024571b95ac` / tree `09e15518f24f6b120c09962296f3d13763dd7bd7`; checks `31624942755` y `31624942721` PASS. V2 superseded sin ejecucion; V3 pendiente. |
...
- Subfase tecnica activa: F10.10 `M3_PUBLIC_DB_ACL_DIAGNOSTIC_V3_PAYLOAD_PENDING_HUMAN_APPROVAL`. Gate v1 consumido, v2 superseded sin ejecucion y v3 pendiente sin continuidad automatica.
...
- Siguiente accion: promover y revisar separadamente el envelope/payload v3; esta autorizacion no ejecuta la lectura.
