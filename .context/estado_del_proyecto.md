...
Snapshot: `SNAPSHOT-2026-08-11-F10.10-M3-POST-MERGE`.
...
| `F10` | Produccion CA1-only | `IN_PROGRESS_REBASELINE_METADATA` | F10.8 queda `COMPLETED_PRODUCTION_CANARY_VERIFIED`; F10.9 conserva `STOP_REQUIRES_REBASELINE`. [M2 post-merge](operaciones/m2_f10_10_post_merge_evidence_2026_08_10.md) registra M1/M2 PASS. La [evidencia M3](operaciones/m3_f10_10_post_merge_evidence_2026_08_11.md) registra el collector promovido y verificado; la ejecucion remota sigue bloqueada hasta gates separados Free/Certification/Pro. Hito 1 sigue `TECHNICALLY_DELIVERED_FORMAL_CLOSURE_PENDING`. |
...
| `F10.10` | `M3_COLLECTOR_PROMOTED_REMOTE_GATES_PENDING` | [ADR-0010](decisiones/ADR-0010_rebaseline_f10_10_metadata_remediation.md), [PLAN-F10.10-001](operaciones/plan_remediacion_metadata_f10_10.md), [evidencia M2](operaciones/m2_f10_10_post_merge_evidence_2026_08_10.md), [scope M3](operaciones/m3_f10_10_scope_por_ambiente_target.md) y [evidencia M3](operaciones/m3_f10_10_post_merge_evidence_2026_08_11.md) preservan la frontera fill-only/sin DDL. PR #350 quedo aprobado/fusionado y sus checks post-merge pasaron; ninguna lectura remota esta autorizada sin el gate exacto del target. |
...
- Subfase tecnica activa: F10.10 `M3_COLLECTOR_PROMOTED_REMOTE_GATES_PENDING`. F10.9 conserva `STOP_REQUIRES_REBASELINE`; G5-G13, schedules y observacion siguen suspendidos. La promocion no concede llamadas remotas: Free, replay Certification y Pro conservan gates separados.
...
- Siguiente accion: preparar el payload completo y solicitar humanamente `APPROVE_M3_FREE_READONLY`, ligado al query-set promovido y al target binding esperado. No ejecutar la lectura sin esa aprobacion exacta. MCP solo puede ser sanity-check no autoritativo; Certification, Pro, M4 y schedules permanecen bloqueados.
