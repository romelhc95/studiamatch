...
| `F10.9` | `REBASELINED_FG2_FG3_OPERATIONAL_REMEDIATION` | PR #376/v1 queda `COMPLETED_POST_MERGE_VERIFIED` en `desarrollo@30f77b88778372de112c6a8fb51a1344155db025` / tree `b25fca6fc4e37db5b1e2c0e048748ee0ec3d839c`; [G5 v2 repository-only](operaciones/g5_v2_repository_only_candidate_2026_08_14.md) queda `G5_V2_REPOSITORY_ONLY_CANDIDATE_PENDING_PROMOTION` para corregir atribucion FG2/FG3. `G4=PASS_CA1_FG2_FG3_ONLY_METADATA_TRANSFERRED_TO_H2`; metadata no es gate de Hito 1. Pares aceptados `0`; observacion `NOT_STARTED`. |
...
- Siguiente accion: aprobar y fusionar el [candidate G5 v2 repository-only](operaciones/g5_v2_repository_only_candidate_2026_08_14.md) por PR protegido a `desarrollo` y verificar CI/post-merge. El gate G5 permanece `NOT_CREATED_NOT_APPROVED_NOT_CONSUMED` y connected mode permanece `STOP_G5_CONNECTED_MODE_NOT_IMPLEMENTED`; no ejecutar Production, adapter, remediacion, schedules ni observacion.
