...
`F10.11_GOV_CI7_POST_MERGE_EVIDENCE_PENDING_R2_WP_H2_ACTIVE_R1_NO_IMPLEMENTATION`
...
| Desarrollo commit | `26a44af87e4e610d905763b6a5b8c14b64607954` |
| Desarrollo tree | `3b956049f3535263b2fdbe3177dc7118005b7af1` |
...
| Work package CI7 evidence fail-closed | `WP-GOV-CI-007=PROPOSED` |
...
`O0-O5 historicos completados; D0-D10 homologado; PR #424, PR #425, PR #426, PR #427, PR #429, PR #430, PR #432, PR #434 y PR #436 publicados en desarrollo; PR #428, PR #431, PR #435 y PR #437 consumieron sus grants; PR #433 y PR #437 completaron O2 pero fallaron CI post-merge; Etapa 1 Obsidian pendiente de GOV-CI7, nuevo O2 HOM-007 R3 JIT y convergencia final; WP-H2-001 activo hasta R1 sin implementacion funcional iniciada.`

## Porcentaje De Desviacion

`F10_11_GOV_CI7_POST_MERGE_EVIDENCE_PENDING_R2`.
...
- El unico siguiente gate permitido es `PREPARE_WP_GOV_CI_007_R2_APPROVAL`.
...
1. Preparar aprobacion humana por digest de `WP-GOV-CI-007` hasta R2.
...
```text
Apruebo WP-GOV-CI-007 de TASK-GOV-CI-007 segun manifest sha256:<D_CI7> contenido en candidate commit:<C_CI7>, hasta R2 y hasta 2026-09-01T23:59:59Z.
Alcance exclusivo y orden obligatorio: push, PR y merge a desarrollo del candidate GOV-CI7 que implementa evidencia post-merge fail-closed y HOM-007; no Certification, no Main y no R3.
Base: desarrollo@26a44af87e4e610d905763b6a5b8c14b64607954, tree 3b956049f3535263b2fdbe3177dc7118005b7af1.
Orden obligatorio: verificar status limpio, verificar WP-GOV-CI-007 aprobado por digest, publicar a desarrollo mediante PR protegido, registrar Governance Attestation con Base-SHA y Candidate-SHA en el body y detenerse ante Certification, Main o gate superior.
...
Stop conditions: status sucio inesperado, digest no coincide, CI fail, path fuera de allowlist, secreto/PII, PR #435 requiere reintento o edicion, cierre F10.11 declarado sin predicado, H2 iniciado, requerimiento R3 no autorizado.
Salida esperada: GOV-CI7 en desarrollo, tri-state post-merge fail-closed, HOM-007 preparado, H2-CA2/H2-CA3 NOT_STARTED y sin gate superior automatico.
