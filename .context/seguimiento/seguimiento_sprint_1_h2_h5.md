...
- El unico siguiente gate permitido es `PREPARE_WP_GOV_OBS_R2_APPROVAL`.
...
1. Preparar aprobacion humana por digest de `WP-GOV-OBS-001` hasta R2.
...
```text
Apruebo WP-GOV-OBS-001 de TASK-GOV-OBS-001 segun manifest sha256:6a2adee53c4aba66ca9f344f67319b72e624ce17408f73928947b9cc404c5060 contenido en candidate commit:<commit_real>, hasta R2 y hasta 2026-08-28T23:59:59Z.
Alcance exclusivo: push, PR y merge a desarrollo del bundle documental Obsidian; no Certification, no Main y no R3.
...
Orden obligatorio: verificar status limpio, verificar WP-GOV-OBS-001 aprobado por digest, verificar commit/tree, publicar a desarrollo mediante PR protegido y detenerse ante Certification, Main o gate superior.
Allowlist: la definida por `WP-GOV-OBS-001`, limitada a documentacion/gobierno; no usar allowlist funcional de `WP-H2-001`.
