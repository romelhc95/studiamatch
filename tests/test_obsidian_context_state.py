...
POST_H2_MERGE_STATE = "QUALITY_CLEANUP_LOCAL_PENDING_REMOTE_VERIFICATION"
POST_H2_PHASE_STATE = "H2_QUALITY_CLEANUP_LOCAL_PENDING_REMOTE_VERIFICATION"
...
NEXT_GATE = "LOCAL_QUALITY_VALIDATION_THEN_PR_466_REVIEW_AND_CI_BEFORE_MERGE"
