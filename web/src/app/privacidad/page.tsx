...
export default function PrivacidadPage() {
  return (
    <div className="section-spacing max-w-3xl mx-auto px-4 sm:px-6 break-words">
      <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-6 break-words">Política de Privacidad</h1>
      <p className="text-slate-600 mb-4">Última actualización: mayo 2026</p>

      <section className="mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-slate-700 mb-3 break-words">1. Información que recopilamos</h2>
      ...
      <section className="mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-slate-700 mb-3 break-words">2. Uso de la información</h2>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-slate-700 mb-3 break-words">3. Datos de terceros</h2>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-slate-700 mb-3 break-words">4. Cookies y analítica</h2>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-lg sm:text-xl font-semibold text-slate-700 mb-3 break-words">5. Contacto</h2>
        <p className="text-slate-600 leading-relaxed">
