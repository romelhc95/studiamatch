...
EXPECTED_WORKFLOW_PATH = ".github/workflows/g5-manual-trust-gate.yml"
...
G5_WORKFLOW_CONNECTED_PR_C_STATUS = "MERGED_POST_MERGE_VERIFIED"
G5_WORKFLOW_CONNECTED_PR_D_STATUS = "DEPLOYMENT_READY_DISABLED_NOT_CONFIGURED"
