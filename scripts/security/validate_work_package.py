...
PROMOTION_CANDIDATE_BRANCHES = {
    "O2 desarrollo -> certificacion": "promote/gov-hom-009-o2-req1",
    "O3 certificacion -> main": "promote/gov-hom-009-o3-req1",
    "O4 main -> certificacion": "promote/gov-hom-009-o4-req1",
    "O5 certificacion -> desarrollo": "promote/gov-hom-009-o5-req1",
}
...
PROMOTION_FINAL_WP = "WP-GOV-CI-009"
...
PROMOTION_BLOCKED_PR_NUMBERS = {428, 431, 433, 435, 437, 440}
PROMOTION_CONSUMED_GRANTS = {"R3-GOV-HOM-001-O2", "R3-GOV-HOM-003-O2-REQ1", "R3-GOV-HOM-004-O2-REQ1", "R3-GOV-HOM-005-O2-REQ1", "R3-GOV-HOM-006-O2-REQ1", "R3-GOV-HOM-008-O2-REQ1"}
PROMOTION_SUPERSEDED_GRANTS = {"R3-GOV-HOM-006-O3-REQ1", "R3-GOV-HOM-006-O4-REQ1", "R3-GOV-HOM-006-O5-REQ1", "R3-GOV-HOM-007-O2-REQ1", "R3-GOV-HOM-007-O3-REQ1", "R3-GOV-HOM-007-O4-REQ1", "R3-GOV-HOM-007-O5-REQ1", "R3-GOV-HOM-008-O2-REQ1", "R3-GOV-HOM-008-O3-REQ1", "R3-GOV-HOM-008-O4-REQ1", "R3-GOV-HOM-008-O5-REQ1"}
...
def validate_static_promotion_requests(root: Path = ROOT) -> list[str]:
    ...
    for family in ("006", "007", "008", "009"):
        ...
        for op, code, base_ref, source_ref in (
            ...
            expected[f"R3-GOV-HOM-{family}-{code}-REQ1"] = (op, base_ref, f"promote/gov-hom-{family}-{code.lower()}-req1", final_wp, source_ref, family in {"007", "008", "009"})
...
def validate_changed_paths(changed: list[tuple[str, str]], manifests: list[dict[str, Any]], *, active_work_package: str = "NONE", activation_transition: bool = False, obsidian_transition: bool = False, gov_obs_transition: bool = False, gov_arch_transition: bool = False, gov_hom_transition: bool = False, gov_ci_transition: bool = False, gov_ci2_transition: bool = False, gov_ci3_transition: bool = False, gov_ci4_transition: bool = False, gov_ci5_transition: bool = False, gov_ci6_transition: bool = False, gov_ci7_transition: bool = False, gov_ci8_transition: bool = False, gov_ci9_transition: bool = False) -> list[str]:
    errors: list[str] = []
...
def main(argv: list[str] | None = None) -> int:
    ...
    errors: list[str] = []
    if len(manifests) != 17:
        errors.append("WP_MANIFEST_COUNT:expected four Sprint 1 manifests plus GOV OBS/INFRA/ARCH/HOM/CI/CI2/CI3/CI4/CI5/CI6/CI7/CI8/CI9 manifests")
