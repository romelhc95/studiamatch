...
# Setup relative paths for imports
...
def run_audit():
    ...
    # Fetch courses with their institution slugs (Universal syntax)
    courses = db.select('courses', filters='is_active=eq.true', columns='*,institutions(slug)')
