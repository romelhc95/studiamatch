...
logger = logging.getLogger("SENATIHarvester")
...
class SENATIHarvester:
    ...
    async def get_course_urls(self, page):
        return [
            "https://www.senati.edu.pe/especialidades/tecnologias-de-la-informacion/ingenieria-de-software-con-ia",
            "https://www.senati.edu.pe/especialidades/tecnologias-de-la-informacion/diseno-y-desarrollo-web",
            "https://www.senati.edu.pe/especialidades/tecnologias-de-la-informacion/redes-y-seguridad-informatica"
        ]

    async def scrape_course_detail(self, page, url):
        logger.info(f"Scraping SENATI: {url}")
        try:
